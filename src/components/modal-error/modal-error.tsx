...
export function ModalError() {
  return (
    <div className={styles.ModalError} data-test-id='button-menu-view-list'>
      <img src={warning} alt="warning" />
      <p>Что-то пошло не так. Обновите страницу через некоторое время.</p>
      <button className={styles.ModalError__close} type='button'> <img src={cross} alt="close" /></button>
